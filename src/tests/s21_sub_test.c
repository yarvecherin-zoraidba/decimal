...
Suite *s21_sub_test(void) {
  Suite *suite = suite_create("\033[33m--s21_sub--\033[0m");
  TCase *tcase_core = tcase_create("sub_tc");
  ...
  tcase_add_test(tcase_core, s21_sub_13);
  tcase_add_test(tcase_core, s21_sub_14);
